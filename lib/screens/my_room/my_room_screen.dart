...
class _MyRoomScreenState extends State<MyRoomScreen> with SingleTickerProviderStateMixin {
            ...
            return GestureDetector(
              ...
              child: Container(
                ...
                child: Row(children: [
                  ...
                  Text(o.$3, style: TextStyle(fontWeight: FontWeight.w600,
      ...
      body: Container(
        ...
        child: SafeArea(
          child: Column(children: [
            ...
            _buildSearchBar(),
            _buildTabBar(activeRooms.length, hiddenRooms.length, draftRooms.length),
  ...
  Widget _buildStats(List<RoomModel> rooms) {
    ...
    return Padding(
      ...
      child: Row(children: [
        _statChip(Icons.home_work_rounded, '${rooms.length}', 'Tổng phòng', AppColors.teal),
        ...
        const SizedBox(width: 8),
        _statChip(Icons.warning_amber_rounded, '${rooms.where((r) => r.isExpired).length}', 'Hết hạn', Colors.orange),
      ]),
    );
  }
  ...
  Widget _buildRoomList(List<RoomModel> rooms, {required String tab}) {
    if (rooms.isEmpty) {
      return Center(child: Column(mainAxisAlignment: MainAxisAlignment.center, children: [
        Icon(
          tab == 'active' ? Icons.home_work_outlined
              : tab == 'hidden' ? Icons.visibility_off_outlined
              : Icons.drafts_outlined,
          size: 64, color: AppColors.textSecondary.withOpacity(0.3)),
        const SizedBox(height: 12),
        Text(
          tab == 'active' ? 'Chưa có phòng đang đăng'
              : tab == 'hidden' ? 'Không có phòng bị ẩn'
              : 'Không có bản nháp',
