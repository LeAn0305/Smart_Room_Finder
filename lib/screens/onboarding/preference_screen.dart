...
class _PreferenceScreenState extends State<PreferenceScreen> {
  ...
  final List<String> _locations = [
    ...
    'Tân Bình', 'Gò Vấp', 'Thủ Đức', 'Bình Chánh', 'Nhà Bè',
  ];
    ...
    return Padding(
      ...
      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
          ...
          TextButton(
            onPressed: _finish,
            child: const Text('Bỏ qua', style: TextStyle(color: AppColors.textSecondary, fontWeight: FontWeight.w600)),
          ),
        ]),
  ...
  Widget _buildStepHeader(String emoji, String title, String subtitle) {
    return Padding(
      ...
      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        ...
        Text(subtitle, style: const TextStyle(fontSize: 15, color: AppColors.textSecondary, height: 1.4)),
      ]),
    );
  }
  ...
  Widget _buildLocationStep() {
    return SingleChildScrollView(
      ...
      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        _buildStepHeader('📍', 'Bạn muốn ở khu vực nào?', 'Chúng tôi sẽ gợi ý phòng gần khu vực bạn chọn.'),
        Padding(
  ...
  Widget _buildTypeStep() {
    return SingleChildScrollView(
      padding: const EdgeInsets.only(bottom: 20),
      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        _buildStepHeader('🏠', 'Bạn thích loại phòng nào?', 'Chọn loại phòng phù hợp với nhu cầu của bạn.'),
        Padding(
          padding: const EdgeInsets.symmetric(horizontal: 24),
  ...
  Widget _buildAmenitiesStep() {
    return SingleChildScrollView(
      padding: const EdgeInsets.only(bottom: 20),
      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        _buildStepHeader('✨', 'Tiện ích bạn cần?', 'Chọn những tiện ích quan trọng với bạn.'),
        Padding(
          padding: const EdgeInsets.symmetric(horizontal: 24),
          child: Wrap(
            spacing: 10, runSpacing: 10,
  ...
  Widget _buildBudgetStep() {
    return SingleChildScrollView(
      padding: const EdgeInsets.only(bottom: 20),
      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        _buildStepHeader('💰', 'Ngân sách hàng tháng?', 'Kéo thanh để chọn mức giá tối đa bạn muốn thuê.'),
        Padding(
          padding: const EdgeInsets.symmetric(horizontal: 24),
          child: Column(children: [
            Container(
              ...
              child: Column(children: [
                ...
                Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                  const Text('1 triệu', style: TextStyle(color: AppColors.textSecondary, fontSize: 13, fontWeight: FontWeight.w600)),
                  const Text('20 triệu', style: TextStyle(color: AppColors.textSecondary, fontSize: 13, fontWeight: FontWeight.w600)),
                ]),
              ]),
            ),
            const SizedBox(height: 20),
