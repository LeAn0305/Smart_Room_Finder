...
import 'package:smart_room_finder/services/notification_service.dart';
...
Future<void> main() async {
  ...
  // Khởi tạo notification service — tự động skip trên Windows/Linux
  ...
  runApp(
    MultiProvider(
      providers: [
        ...
        ChangeNotifierProvider(create: (_) => RoomProvider()..fetchRooms()),
