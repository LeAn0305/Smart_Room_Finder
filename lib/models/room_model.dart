...
class RoomModel {
  ...
  static List<RoomModel> sampleRooms = [
    ...
    RoomModel(
      id: '13',
      ownerId: 'user_1',
      title: 'Căn hộ studio Hoàn Kiếm',
      description: 'Studio hiện đại ngay trung tâm Hà Nội, gần Hồ Gươm, đầy đủ nội thất.',
      price: 8000000,
      address: 'Phố Hàng Bài, Hoàn Kiếm, Hà Nội',
      imageUrl: 'assets/images/room_muji_studio.png',
      images: ['assets/images/room_muji_studio.png', 'assets/images/room_studio_luxury.png'],
      rating: 4.6,
      type: RoomType.apartment,
      location: 'Hà Nội',
      amenities: ['Wifi', 'Máy lạnh', 'Tủ lạnh', 'Bếp', 'Thang máy'],
      isVerified: true,
      viewCount: 210,
      contactCount: 28,
      area: 35,
    ...
    RoomModel(
      ...
      description: 'Phòng trọ gần ĐH Quốc Gia Hà Nội, giá sinh viên, an ninh tốt.',
      price: 2500000,
      ...
      type: RoomType.studio,
      location: 'Hà Nội',
      amenities: ['Wifi', 'WC riêng', 'Chỗ để xe', 'Bảo vệ'],
      isVerified: true,
      viewCount: 95,
      contactCount: 10,
      area: 18,
    ...
    RoomModel(
      ...
      description: 'Nhà nguyên căn 3 tầng, 3 phòng ngủ, gần trung tâm Hà Nội.',
      price: 15000000,
      ...
      type: RoomType.house,
      location: 'Hà Nội',
      amenities: ['Wifi', 'Máy lạnh', 'Bếp', 'Sân thượng', 'Hầm xe'],
      isVerified: true,
      viewCount: 130,
      contactCount: 15,
      area: 90,
    ...
    RoomModel(
      ...
      description: 'Căn hộ cao cấp view biển Mỹ Khê tuyệt đẹp, đầy đủ tiện nghi.',
      price: 12000000,
      ...
      type: RoomType.apartment,
      location: 'Đà Nẵng',
      amenities: ['Wifi', 'Máy lạnh', 'Tủ lạnh', 'Hồ bơi', 'Gym', 'Bảo vệ 24/7'],
      isVerified: true,
      viewCount: 280,
      contactCount: 40,
      area: 55,
    ...
    RoomModel(
      id: '17',
      ownerId: 'user_2',
      title: 'Phòng trọ Hải Châu giá rẻ',
      description: 'Phòng trọ sạch sẽ, gần trung tâm Đà Nẵng, tiện đi lại.',
      price: 2800000,
      address: 'Đường Lê Duẩn, Hải Châu, Đà Nẵng',
      imageUrl: 'assets/images/phong_tro_gac_sat.png',
      images: ['assets/images/phong_tro_gac_sat.png'],
      rating: 3.9,
      type: RoomType.studio,
      location: 'Đà Nẵng',
    ...
    RoomModel(
      id: '18',
      ownerId: 'user_3',
      title: 'Căn hộ mini Ninh Kiều',
      description: 'Căn hộ nhỏ gọn gần bến Ninh Kiều, view sông Cần Thơ đẹp.',
      price: 4000000,
    ...
    RoomModel(
      id: '19',
      ownerId: 'user_1',
      title: 'Nhà phố Lê Chân',
      description: 'Nhà phố 2 tầng, 2 phòng ngủ, gần trung tâm Hải Phòng.',
      price: 7000000,
      address: 'Đường Tô Hiệu, Lê Chân, Hải Phòng',
      imageUrl: 'assets/images/room_house_alley.png',
      images: ['assets/images/room_house_alley.png'],
      rating: 4.2,
      type: RoomType.house,
      location: 'Hải Phòng',
      amenities: ['Wifi', 'Máy lạnh', 'Bếp', 'Sân phơi'],
      isVerified: true,
      viewCount: 80,
      contactCount: 9,
      area: 60,
    ...
    RoomModel(
      id: '20',
      ownerId: 'user_2',
      title: 'Phòng trọ sinh viên TP Huế',
      description: 'Phòng trọ gần ĐH Huế, yên tĩnh, phù hợp sinh viên.',
      price: 1500000,
      address: 'Đường Lê Lợi, TP. Huế, Thừa Thiên Huế',
      imageUrl: 'assets/images/room_student_room.png',
      images: ['assets/images/room_student_room.png'],
      rating: 3.7,
      type: RoomType.studio,
      location: 'Huế',
      amenities: ['Wifi', 'WC chung', 'Chỗ để xe máy'],
    ...
    RoomModel(
      id: '21',
      ownerId: 'user_3',
      title: 'Căn hộ biển Nha Trang',
      description: 'Căn hộ cao cấp view biển Nha Trang, gần trung tâm thành phố.',
      price: 10000000,
      address: 'Đường Trần Phú, Nha Trang, Khánh Hòa',
      imageUrl: 'assets/images/room_apartment_horizon.png',
      images: ['assets/images/room_apartment_horizon.png'],
      rating: 4.7,
      type: RoomType.apartment,
      location: 'Khánh Hòa',
      amenities: ['Wifi', 'Máy lạnh', 'Hồ bơi', 'Bảo vệ 24/7'],
      isVerified: true,
      viewCount: 190,
      contactCount: 25,
      area: 50,
    ...
    RoomModel(
      id: '22',
      ownerId: 'user_1',
      title: 'Nhà vườn Đà Lạt',
      description: 'Nhà vườn yên tĩnh, không khí mát mẻ, view đồi thông tuyệt đẹp.',
      price: 6000000,
      address: 'Đường Trần Hưng Đạo, Đà Lạt, Lâm Đồng',
      imageUrl: 'assets/images/room_house_frontage.png',
      images: ['assets/images/room_house_frontage.png'],
      rating: 4.5,
      type: RoomType.house,
      location: 'Lâm Đồng',
      amenities: ['Wifi', 'Bếp', 'Sân vườn', 'Chỗ để xe'],
      isVerified: true,
      viewCount: 110,
      contactCount: 12,
      area: 70,
