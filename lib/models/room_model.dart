...
class RoomModel {
  ...
  static final List<RoomModel> sampleRooms = [
    ...
    RoomModel(
      id: 'dspt_13',
      ownerId: 'user_dspt_13',
      title: 'Nhà nguyên căn 3PN gần CVPM Quang Trung',
      description:
          '3 phòng ngủ, 3 WC riêng, phòng khách rộng, bếp riêng. Không chung chủ, tự do sinh hoạt.',
      price: 10500000,
      address: 'Gần CVPM Quang Trung, Quận 12, TP. Hồ Chí Minh',
      location: 'Quận 12',
      mainImageUrl: 'assets/images/rooms/dspt/image33.jpeg',
      subImageUrls: [
        'assets/images/rooms/dspt/image34.jpeg',
        'assets/images/rooms/dspt/image35.jpeg',
      ],
      rating: 4.9,
      type: RoomType.house,
      bedrooms: 3,
      amenities: ['3PN', '3WC', 'Bếp riêng', 'Tự do'],
      isVerified: true,
      approvalStatus: RoomStatus.verified,
      postedAt: DateTime.now(),
    ),
    RoomModel(
      id: 'dspt_16',
      ownerId: 'user_dspt_16',
      title: 'Phòng mới sạch đẹp gần cầu Tham Lương',
      description: 'Full nội thất, vào ở ngay. Gần KCN Tân Bình.',
      price: 4990000,
      address: 'Gần cầu Tham Lương, Tân Bình, TP. Hồ Chí Minh',
      location: 'Tân Bình',
      mainImageUrl: 'assets/images/rooms/dspt/image40.jpeg',
      subImageUrls: [
        'assets/images/rooms/dspt/image41.jpeg',
        'assets/images/rooms/dspt/image42.jpeg',
      ],
      rating: 4.7,
      type: RoomType.studio,
      amenities: ['Full nội thất', 'Mới', 'Gần KCN'],
      isVerified: true,
      approvalStatus: RoomStatus.verified,
      postedAt: DateTime.now(),
    ),
