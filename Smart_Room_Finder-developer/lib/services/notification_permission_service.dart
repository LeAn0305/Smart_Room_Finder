...
/// Trên Web và các nền tảng khác, quyền được cấp tự động hoặc do browser xử lý.
class NotificationPermissionService {
  /// Kiểm tra có phải Android không (an toàn với mọi nền tảng)
  static bool get _isAndroid =>
      !kIsWeb && defaultTargetPlatform == TargetPlatform.android;

  /// Xin quyền notification. Trả về true nếu được cấp quyền.
  static Future<bool> requestPermission() async {
    // Chỉ cần xin trên Android; Web/iOS/Desktop tự xử lý
  ...
  static Future<bool> requestWithExplanation(BuildContext context) async {
    // Trên Web: Firebase Messaging tự xử lý quyền notification
    // Trên Desktop (Windows/Linux/macOS): không hỗ trợ, bỏ qua
    if (!_isAndroid) return true;
